...
public class DataDao {
    ...
    public String insertQandA(QandA data) {
        ...
        String INDEX = "qa";
        IndexRequest indexRequest = new IndexRequest(INDEX, "type", uniqueID)
                .source(dataMap);
        try {
    ...
    public List<QandA> getAllQandA() throws IOException {
    ...
    public QandA updateQandAById(String id, QandA qandA) throws IOException {
        ...
        UpdateRequest updateRequest = new UpdateRequest("qa", "type", id).doc(dataMap);
        UpdateResponse updateResponse = restHighLevelClient.update(updateRequest, RequestOptions.DEFAULT);
        return qandA;
    }

    public String deleteQandAById(String id) throws IOException {
        DeleteRequest deleteRequest = new DeleteRequest("qa", "type", id);
